...
int round(double d);
double max_lst(double *list, double len);
int sign(double n);
...
int main() {
	...
	double **u_cor_1 = (double **)malloc((N_max + 1) * sizeof(double *));
	for (int i = 0; i < N_max + 1; i++) {
		u_cor_1[i] = (double *)malloc((I_max + 1) * sizeof(double));
	}

	double **u_cor_2 = (double **)malloc((N_max + 1) * sizeof(double *));
	for (int i = 0; i < N_max + 1; i++) {
		u_cor_2[i] = (double *)malloc((I_max + 1) * sizeof(double));
	}

	double **u_cor_3 = (double **)malloc((N_max + 1) * sizeof(double *));
	for (int i = 0; i < N_max + 1; i++) {
		u_cor_3[i] = (double *)malloc((I_max + 1) * sizeof(double));
	}

	double **u_cor_4 = (double **)malloc((N_max + 1) * sizeof(double *));
	for (int i = 0; i < N_max + 1; i++) {
		u_cor_4[i] = (double *)malloc((I_max + 1) * sizeof(double));
	}

	// create meshes for correction part parameters

	double *f_cor_left_1 = (double *)malloc((I_max + 1) * sizeof(double));
	double *f_cor_right_1 = (double *)malloc((I_max + 1) * sizeof(double));
	double *f_cor_left_2 = (double *)malloc((I_max + 1) * sizeof(double));
	double *f_cor_right_2 = (double *)malloc((I_max + 1) * sizeof(double));
	double *f_cor_left_3 = (double *)malloc((I_max + 1) * sizeof(double));
	double *f_cor_right_3 = (double *)malloc((I_max + 1) * sizeof(double));
	double *f_cor_left_4 = (double *)malloc((I_max + 1) * sizeof(double));
	double *f_cor_right_4 = (double *)malloc((I_max + 1) * sizeof(double));
	...
	for (int n = 0; n < N_max; n++) {
		...
		for (int i = 2; i < I_max - 1; i++) {
			s = sign(u_td_1[n + 1][i + 1] - u_td_1[n + 1][i]);
			...
			s = sign(u_td_2[n + 1][i + 1] - u_td_2[n + 1][i]);
			...
			s = sign(u_td_3[n + 1][i + 1] - u_td_3[n + 1][i]);
			...
			s = sign(u_td_4[n + 1][i + 1] - u_td_4[n + 1][i]);
		...
		tau = k * h / (2 * mu_0 + max_lst(v_mesh, I_max + 1));
	}
	...
	for (int i = 0; i < I_max + 1; i++) {
		rho_lst[i] = u_cor_1[n][i] / S_mesh[i];
	}

	// for velocity

	for (int i = 0; i < I_max + 1; i++) {
		v_lst[i] = u_cor_2[n][i] / u_cor_1[n][i];
	}

	// for energy

	for (int i = 0; i < I_max + 1; i++) {
		e_lst[i] = u_cor_3[n][i] / u_cor_1[n][i];
	}

	// for strength

	for (int i = 0; i < I_max + 1; i++) {
		H_lst[i] = u_cor_4[n][i] / S_mesh[i];
	}
	...
	delete [] f_cor_left_1;
	delete [] f_cor_right_1;
	delete [] f_cor_left_2;
	delete [] f_cor_right_2;
	delete [] f_cor_left_3;
	delete [] f_cor_right_3;
	delete [] f_cor_left_4;
	delete [] f_cor_right_4;
