...
double r1(double z) {
	return 0.45 - pow((z - 0.5), 2);
}

double r2(double z) {
	return 0.65 + pow((z - 0.5), 2);
}
...
#pragma omp for
	for (int n = 0; n < N_max; n++) {
		...
		for (int l = 1; l < L_max + 1; l++) {
			...
			/*u_td_1_next[l][0] = u_td_1[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_1[l + 1][0] - u_td_1[l][0]) - 
														  mu_l_left[l][0] * (u_td_1[l][0] - u_td_1[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_1[l][1] - u_td_1[l][0]));
			u_td_2_next[l][0] = u_td_2[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_2[l + 1][0] - u_td_2[l][0]) - 
														  mu_l_left[l][0] * (u_td_2[l][0] - u_td_2[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_2[l][1] - u_td_2[l][0]) + 
																 r[l][0] * (r_z[l][0] * P[l][0] + H_z[l][0] * H_y[l][0]));
			u_td_3_next[l][0] = u_td_3[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_3[l + 1][0] - u_td_3[l][0]) - 
														  mu_l_left[l][0] * (u_td_3[l][0] - u_td_3[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_3[l][1] - u_td_3[l][0]) - 
																 r[l][0] * (P[l][0] - H_r[l][0] * H_y[l][0]));
			u_td_4_next[l][0] = u_td_4[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_4[l + 1][0] - u_td_4[l][0]) - 
														  mu_l_left[l][0] * (u_td_4[l][0] - u_td_4[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_4[l][1] - u_td_4[l][0]));
			u_td_5_next[l][0] = u_td_5[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_5[l + 1][0] - u_td_5[l][0]) - 
														  mu_l_left[l][0] * (u_td_5[l][0] - u_td_5[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_5[l][1] - u_td_5[l][0]));
			u_td_6_next[l][0] = u_td_6[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_6[l + 1][0] - u_td_6[l][0]) - 
														  mu_l_left[l][0] * (u_td_6[l][0] - u_td_6[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_6[l][1] - u_td_6[l][0]));
			u_td_7_next[l][0] = u_td_7[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_7[l + 1][0] - u_td_7[l][0]) - 
														  mu_l_left[l][0] * (u_td_7[l][0] - u_td_7[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_7[l][1] - u_td_7[l][0]));
			u_td_8_next[l][0] = u_td_8[l][0] + dt / dz * (mu_l_right[l][0] * (u_td_8[l + 1][0] - u_td_8[l][0]) - 
														  mu_l_left[l][0] * (u_td_8[l][0] - u_td_8[l - 1][0])) + 
											   2 * dt / dr[l] * (mu_m_right[l][0] * (u_td_8[l][1] - u_td_8[l][0]));

			u_td_1_next[l][M_max] = u_td_1[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_1[l + 1][M_max] - u_td_1[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_1[l][M_max] - u_td_1[l - 1][M_max])) + 
													   2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_td_1[l][M_max] - u_td_1[l][M_max - 1]));
			u_td_2_next[l][M_max] = u_td_2[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_2[l + 1][M_max] - u_td_2[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_2[l][M_max] - u_td_2[l - 1][M_max])) + 
													   2 * dt / dr[l] * (r[l][M_max] * (r_z[l][M_max] * P[l][M_max] + H_z[l][M_max] * H_y[l][M_max]) - 
																 mu_m_left[l][M_max] * (u_td_2[l][M_max] - u_td_2[l][M_max - 1]));
			u_td_3_next[l][M_max] = u_td_3[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_3[l + 1][M_max] - u_td_3[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_3[l][M_max] - u_td_3[l - 1][M_max])) + 
													   2 * dt / dr[l] * (r[l][M_max] * (P[l][M_max] - H_r[l][M_max] * H_y[l][M_max]) - 
																 mu_m_left[l][M_max] * (u_td_3[l][M_max] - u_td_3[l][M_max - 1]));
			u_td_4_next[l][M_max] = u_td_4[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_4[l + 1][M_max] - u_td_4[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_4[l][M_max] - u_td_4[l - 1][M_max])) + 
													   2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_td_4[l][M_max] - u_td_4[l][M_max - 1]));
			u_td_5_next[l][M_max] = u_td_5[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_5[l + 1][M_max] - u_td_5[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_5[l][M_max] - u_td_5[l - 1][M_max])) + 
													   2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_td_5[l][M_max] - u_td_5[l][M_max - 1]));
			u_td_6_next[l][M_max] = u_td_6[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_6[l + 1][M_max] - u_td_6[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_6[l][M_max] - u_td_6[l - 1][M_max])) + 
													   2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_td_6[l][M_max] - u_td_6[l][M_max - 1]));
			u_td_7_next[l][M_max] = u_td_7[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_7[l + 1][M_max] - u_td_7[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_7[l][M_max] - u_td_7[l - 1][M_max])) + 
													   2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_td_7[l][M_max] - u_td_7[l][M_max - 1]));
			u_td_8_next[l][M_max] = u_td_8[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_td_8[l + 1][M_max] - u_td_8[l][M_max]) - 
																  mu_l_left[l][M_max] * (u_td_8[l][M_max] - u_td_8[l - 1][M_max])) + 
													   2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_td_8[l][M_max] - u_td_8[l][M_max - 1]));*/
		}
		...
		for (int m = 1; m < M_max; m++) {
			...
			u_td_1_next[L_max][m] = u_td_1_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_td_2_next[L_max][m] = u_td_2_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_td_3_next[L_max][m] = u_td_3_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_td_4_next[L_max][m] = u_td_4_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_td_5_next[L_max][m] = u_td_5_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_td_6_next[L_max][m] = u_td_6_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max - 1][m] / r[L_max][m];
			// u_td_7_next[L_max][m] = u_td_7_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_td_7_next[L_max][m] = H_y[L_max][m] * r[L_max][m] - (-e[L_max][m] * r[L_max][m] + (e[L_max - 1][m] + e[L_max][m]) * (r[L_max - 1][m] + r[L_max][m]) / 4.0) * 2 / dz * dt;
			u_td_8_next[L_max][m] = u_td_8_next[L_max - 1][m] * dr[L_max - 1] / dr[L_max];
		}
		...
		for (int l = 1; l < L_max + 1; l++) {
			...
			/*u_ad_1[l][0] = u_ad_1[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_1[l + 1][0] - u_ad_1[l][0]) - 
													 mu_l_left[l][0] * (u_ad_1[l][0] - u_ad_1[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_1[l][1] - u_ad_1[l][0]));
			u_ad_2[l][0] = u_ad_2[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_2[l + 1][0] - u_ad_2[l][0]) - 
													 mu_l_left[l][0] * (u_ad_2[l][0] - u_ad_2[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_2[l][1] - u_ad_2[l][0]) + 
															r[l][0] * (r_z[l][0] * P[l][0] + H_z[l][0] * H_y[l][0]));
			u_ad_3[l][0] = u_ad_3[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_3[l + 1][0] - u_ad_3[l][0]) - 
													 mu_l_left[l][0] * (u_ad_3[l][0] - u_ad_3[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_3[l][1] - u_ad_3[l][0]) - 
															r[l][0] * (P[l][0] - H_r[l][0] * H_y[l][0]));
			u_ad_4[l][0] = u_ad_4[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_4[l + 1][0] - u_ad_4[l][0]) - 
													 mu_l_left[l][0] * (u_ad_4[l][0] - u_ad_4[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_4[l][1] - u_ad_4[l][0]));
			u_ad_5[l][0] = u_ad_5[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_5[l + 1][0] - u_ad_5[l][0]) - 
													 mu_l_left[l][0] * (u_ad_5[l][0] - u_ad_5[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_5[l][1] - u_ad_5[l][0]));
			u_ad_6[l][0] = u_ad_6[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_6[l + 1][0] - u_ad_6[l][0]) - 
													 mu_l_left[l][0] * (u_ad_6[l][0] - u_ad_6[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_6[l][1] - u_ad_6[l][0]));
			u_ad_7[l][0] = u_ad_7[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_7[l + 1][0] - u_ad_7[l][0]) - 
													 mu_l_left[l][0] * (u_ad_7[l][0] - u_ad_7[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_7[l][1] - u_ad_7[l][0]));
			u_ad_8[l][0] = u_ad_8[l][0] + dt / dz * (mu_l_right[l][0] * (u_ad_8[l + 1][0] - u_ad_8[l][0]) - 
													 mu_l_left[l][0] * (u_ad_8[l][0] - u_ad_8[l - 1][0])) + 
										  2 * dt / dr[l] * (mu_m_right[l][0] * (u_ad_8[l][1] - u_ad_8[l][0]));

			u_ad_1[l][M_max] = u_ad_1[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_1[l + 1][M_max] - u_ad_1[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_1[l][M_max] - u_ad_1[l - 1][M_max])) + 
												  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_ad_1[l][M_max] - u_ad_1[l][M_max - 1]));
			u_ad_2[l][M_max] = u_ad_2[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_2[l + 1][M_max] - u_ad_2[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_2[l][M_max] - u_ad_2[l - 1][M_max])) + 
												  2 * dt / dr[l] * (r[l][M_max] * (r_z[l][M_max] * P[l][M_max] + H_z[l][M_max] * H_y[l][M_max]) - 
																	mu_m_left[l][M_max] * (u_ad_2[l][M_max] - u_ad_2[l][M_max - 1]));
			u_ad_3[l][M_max] = u_ad_3[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_3[l + 1][M_max] - u_ad_3[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_3[l][M_max] - u_ad_3[l - 1][M_max])) + 
												  2 * dt / dr[l] * (r[l][M_max] * (P[l][M_max] - H_r[l][M_max] * H_y[l][M_max]) - 
																	mu_m_left[l][M_max] * (u_ad_3[l][M_max] - u_ad_3[l][M_max - 1]));
			u_ad_4[l][M_max] = u_ad_4[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_4[l + 1][M_max] - u_ad_4[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_4[l][M_max] - u_ad_4[l - 1][M_max])) + 
												  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_ad_4[l][M_max] - u_ad_4[l][M_max - 1]));
			u_ad_5[l][M_max] = u_ad_5[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_5[l + 1][M_max] - u_ad_5[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_5[l][M_max] - u_ad_5[l - 1][M_max])) + 
												  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_ad_5[l][M_max] - u_ad_5[l][M_max - 1]));
			u_ad_6[l][M_max] = u_ad_6[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_6[l + 1][M_max] - u_ad_6[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_6[l][M_max] - u_ad_6[l - 1][M_max])) + 
												  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_ad_6[l][M_max] - u_ad_6[l][M_max - 1]));
			u_ad_7[l][M_max] = u_ad_7[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_7[l + 1][M_max] - u_ad_7[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_7[l][M_max] - u_ad_7[l - 1][M_max])) + 
												  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_ad_7[l][M_max] - u_ad_7[l][M_max - 1]));
			u_ad_8[l][M_max] = u_ad_8[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_ad_8[l + 1][M_max] - u_ad_8[l][M_max]) - 
															 mu_l_left[l][M_max] * (u_ad_8[l][M_max] - u_ad_8[l - 1][M_max])) + 
												  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_ad_8[l][M_max] - u_ad_8[l][M_max - 1]));*/
		...
		for (int m = 1; m < M_max; m++) {
			...
			u_ad_1[L_max][m] = u_ad_1[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_ad_2[L_max][m] = u_ad_2[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_ad_3[L_max][m] = u_ad_3[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_ad_4[L_max][m] = u_ad_4[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_ad_5[L_max][m] = u_ad_5[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_ad_6[L_max][m] = u_ad_6[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max - 1][m] / r[L_max][m];
			// u_ad_7[L_max][m] = u_ad_7[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			u_ad_7[L_max][m] = H_y[L_max][m] * r[L_max][m] - (-e[L_max][m] * r[L_max][m] + (e[L_max - 1][m] + e[L_max][m]) * (r[L_max - 1][m] + r[L_max][m]) / 4.0) * 2 / dz * dt;
			u_ad_8[L_max][m] = u_ad_8[L_max - 1][m] * dr[L_max - 1] / dr[L_max];
		...
		for (int l = 1; l < L_max + 1; l++) {
			...
			//u_cor_1[l][0] = u_cor_1[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_1[l + 1][0] - u_cor_1[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_1[l][0] - u_cor_1[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_1[l][1] - u_cor_1[l][0]));
			//u_cor_2[l][0] = u_cor_2[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_2[l + 1][0] - u_cor_2[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_2[l][0] - u_cor_2[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_2[l][1] - u_cor_2[l][0]) + 
			//												  r[l][0] * (r_z[l][0] * P[l][0] + H_z[l][0] * H_y[l][0]));
			//u_cor_3[l][0] = u_cor_3[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_3[l + 1][0] - u_cor_3[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_3[l][0] - u_cor_3[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_3[l][1] - u_cor_3[l][0]) - 
			//												  /*r[l][0] * */(P[l][0] - H_r[l][0] * H_y[l][0]));
			//u_cor_4[l][0] = u_cor_4[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_4[l + 1][0] - u_cor_4[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_4[l][0] - u_cor_4[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_4[l][1] - u_cor_4[l][0]));
			//u_cor_5[l][0] = u_cor_5[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_5[l + 1][0] - u_cor_5[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_5[l][0] - u_cor_5[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_5[l][1] - u_cor_5[l][0]));
			//u_cor_6[l][0] = u_cor_6[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_6[l + 1][0] - u_cor_6[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_6[l][0] - u_cor_6[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_6[l][1] - u_cor_6[l][0]));
			//u_cor_7[l][0] = u_cor_7[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_7[l + 1][0] - u_cor_7[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_7[l][0] - u_cor_7[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_7[l][1] - u_cor_7[l][0]));
			//u_cor_8[l][0] = u_cor_8[l][0] + dt / dz * (mu_l_right[l][0] * (u_cor_8[l + 1][0] - u_cor_8[l][0]) - 
			//										   mu_l_left[l][0] * (u_cor_8[l][0] - u_cor_8[l - 1][0])) + 
			//								2 * dt / dr[l] * (mu_m_right[l][0] * (u_cor_8[l][1] - u_cor_8[l][0]));

			//u_cor_1[l][M_max] = u_cor_1[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_1[l + 1][M_max] - u_cor_1[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_1[l][M_max] - u_cor_1[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_cor_1[l][M_max] - u_cor_1[l][M_max - 1]));
			//u_cor_2[l][M_max] = u_cor_2[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_2[l + 1][M_max] - u_cor_2[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_2[l][M_max] - u_cor_2[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (r[l][M_max] * (r_z[l][M_max] * P[l][M_max] + H_z[l][M_max] * H_y[l][M_max]) - 
			//														mu_m_left[l][M_max] * (u_cor_2[l][M_max] - u_cor_2[l][M_max - 1]));
			//u_cor_3[l][M_max] = u_cor_3[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_3[l + 1][M_max] - u_cor_3[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_3[l][M_max] - u_cor_3[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (/*r[l][M_max] * */(P[l][M_max] - H_r[l][M_max] * H_y[l][M_max]) - 
			//														mu_m_left[l][M_max] * (u_cor_3[l][M_max] - u_cor_3[l][M_max - 1]));
			//u_cor_4[l][M_max] = u_cor_4[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_4[l + 1][M_max] - u_cor_4[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_4[l][M_max] - u_cor_4[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_cor_4[l][M_max] - u_cor_4[l][M_max - 1]));
			//u_cor_5[l][M_max] = u_cor_5[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_5[l + 1][M_max] - u_cor_5[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_5[l][M_max] - u_cor_5[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_cor_5[l][M_max] - u_cor_5[l][M_max - 1]));
			//u_cor_6[l][M_max] = u_cor_6[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_6[l + 1][M_max] - u_cor_6[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_6[l][M_max] - u_cor_6[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_cor_6[l][M_max] - u_cor_6[l][M_max - 1]));
			//u_cor_7[l][M_max] = u_cor_7[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_7[l + 1][M_max] - u_cor_7[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_7[l][M_max] - u_cor_7[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_cor_7[l][M_max] - u_cor_7[l][M_max - 1]));
			//u_cor_8[l][M_max] = u_cor_8[l][M_max] + dt / dz * (mu_l_right[l][M_max] * (u_cor_8[l + 1][M_max] - u_cor_8[l][M_max]) - 
			//												 mu_l_left[l][M_max] * (u_cor_8[l][M_max] - u_cor_8[l - 1][M_max])) + 
			//									  2 * dt / dr[l] * (- mu_m_left[l][M_max] * (u_cor_8[l][M_max] - u_cor_8[l][M_max - 1]));
		...
		for (int m = 1; m < M_max; m++) {
			...
			//u_cor_1[L_max][m] = u_cor_1[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			//u_cor_2[L_max][m] = u_cor_2[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			//u_cor_3[L_max][m] = u_cor_3[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			//u_cor_4[L_max][m] = u_cor_4[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			//u_cor_5[L_max][m] = u_cor_5[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			//u_cor_6[L_max][m] = u_cor_6[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max - 1][m] / r[L_max][m];
			//// u_cor_7[L_max][m] = u_cor_7[L_max - 1][m] * dr[L_max - 1] / dr[L_max] * r[L_max][m] / r[L_max - 1][m];
			//u_cor_7[L_max][m] = H_y[L_max][m] * r[L_max][m] - (-e[L_max][m] * r[L_max][m] + (e[L_max - 1][m] + e[L_max][m]) * (r[L_max - 1][m] + r[L_max][m]) / 4.0) * 2 / dz * dt;
			//u_cor_8[L_max][m] = u_cor_8[L_max - 1][m] * dr[L_max - 1] / dr[L_max];
