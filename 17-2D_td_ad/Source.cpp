...
int main() {
	...
	for (int n = 0; n < N_max; n++) {
		...
		for (int l = 0; l < L_max + 1; l++) {
			for (int m = 0; m < M_max + 1; m++) {
				rho[l][m] = u_ad_1[l][m] / r[l][m];
				v_z[l][m] = u_ad_2[l][m] / u_ad_1[l][m];
				v_r[l][m] = u_ad_3[l][m] / u_ad_1[l][m];
				v_phi[l][m] = u_ad_4[l][m] / u_ad_1[l][m];
				v_y[l][m] = v_r[l][m] - v_z[l][m] * r_z[l][m];

				H_phi[l][m] = u_ad_6[l][m];
				H_z[l][m] = u_ad_7[l][m] / r[l][m];
				H_r[l][m] = u_ad_8[l][m] / r[l][m];
				H_y[l][m] = H_r[l][m] - H_z[l][m] * r_z[l][m];

				e[l][m] = u_ad_5[l][m] / u_ad_1[l][m];
		...
		for (int l = 0; l < L_max + 1; l++) {
			for (int m = 0; m < M_max + 1; m++) {
				u_td_1[l][m] = u_ad_1[l][m];
				u_td_2[l][m] = u_ad_2[l][m];
				u_td_3[l][m] = u_ad_3[l][m];
				u_td_4[l][m] = u_ad_4[l][m];
				u_td_5[l][m] = u_ad_5[l][m];
				u_td_6[l][m] = u_ad_6[l][m];
				u_td_7[l][m] = u_ad_7[l][m];
				u_td_8[l][m] = u_ad_8[l][m];
			}
		}
	}
