		...
		for (int l = 1; l < L_max; l++) {
			for (int m = 1; m < M_max; m++) {
				...
				C_0[l][m] = 1 - dt / dz * (v_z[l + 1][m] - v_z[l - 1][m]) / 4.0 -
								dt / (dy * R[l]) * (v_y[l][m + 1] - v_y[l][m - 1]) / 4.0 -
		...
		for (int l = 1; l < L_max; l++) {
			for (int m = 1; m < M_max; m++) {
				...
				u_td_2_next[l][m] = C_0[l][m] * u_td_2[l][m] + 
									...
									dt / (2.0 * dy * R[l]) * ((r_z[l][m + 1] * P[l][m + 1] + H_z[l][m + 1] * H_y[l][m + 1]) * r[l][m + 1] - 
				...
				u_td_3_next[l][m] = C_0[l][m] * u_td_3[l][m] + 
									...
									dt / (2.0 * dy * R[l]) * ((P[l][m + 1] - H_r[l][m + 1] * H_y[l][m + 1]) * r[l][m + 1] -
				...
				u_td_4_next[l][m] = C_0[l][m] * u_td_4[l][m] + 
									...
									dt / (2.0 * dy * R[l]) * (H_phi[l][m + 1] * H_y[l][m + 1] * r[l][m + 1] -
				...
				u_td_5_next[l][m] = C_0[l][m] * u_td_5[l][m] + 
									...
									dt * p[l][m] * (1.0 / (2.0 * dz) * (v_z[l + 1][m] * r[l + 1][m] * R[l + 1] -
													...
													1.0 / (2.0 * dy * R[l]) * (v_y[l][m + 1] * r[l][m + 1] -
																			   v_y[l][m - 1] * r[l][m - 1]));
				...
				u_td_6_next[l][m] = C_0[l][m] * u_td_6[l][m] + 
									...
									dt / (2.0 * dy * R[l]) * (H_y[l][m + 1] * v_phi[l][m + 1] -
				...
				u_td_7_next[l][m] = C_0[l][m] * u_td_7[l][m] + 
									...
									dt / (2.0 * dy * R[l]) * (H_y[l][m + 1] * v_z[l][m + 1] * r[l][m + 1] -
