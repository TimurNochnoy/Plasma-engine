...
int main() {
	...
	for (int n = 0; n < N_max; n++) {
		...
		for (int l = 1; l < L_max + 1; l++) {
			...
			u_td_1_next[l][0] = 2 * u_td_1_next[l][1] - u_td_1_next[l][2];
			u_td_2_next[l][0] = 2 * u_td_2_next[l][1] - u_td_2_next[l][2];
			u_td_3_next[l][0] = u_td_2_next[l][0] * r_z[l][0];
			u_td_4_next[l][0] = 2 * u_td_4_next[l][1] - u_td_4_next[l][2];
			u_td_5_next[l][0] = 2 * u_td_5_next[l][1] - u_td_5_next[l][2];
			u_td_6_next[l][0] = 2 * u_td_6_next[l][1] - u_td_6_next[l][2];
			u_td_7_next[l][0] = 2 * u_td_7_next[l][1] - u_td_7_next[l][2];
			u_td_8_next[l][0] = u_td_7_next[l][0] * r_z[l][0];
			...
			u_td_1_next[l][M_max] = 2 * u_td_1_next[l][M_max - 1] - u_td_1_next[l][M_max - 2];
			u_td_2_next[l][M_max] = 2 * u_td_2_next[l][M_max - 1] - u_td_2_next[l][M_max - 2];
			u_td_3_next[l][M_max] = u_td_2_next[l][M_max] * r_z[l][M_max];
			u_td_4_next[l][M_max] = 2 * u_td_4_next[l][M_max - 1] - u_td_4_next[l][M_max - 2];
			u_td_5_next[l][M_max] = 2 * u_td_5_next[l][M_max - 1] - u_td_5_next[l][M_max - 2];
			u_td_6_next[l][M_max] = 2 * u_td_6_next[l][M_max - 1] - u_td_6_next[l][M_max - 2];
			u_td_7_next[l][M_max] = 2 * u_td_7_next[l][M_max - 1] - u_td_7_next[l][M_max - 2];
			u_td_8_next[l][M_max] = u_td_7_next[l][M_max] * r_z[l][M_max];
		}
		...
		for (int m = 1; m < M_max; m++) {
			...
			u_td_1_next[L_max][m] = 2 * u_td_1_next[L_max - 1][m] - u_td_1_next[L_max - 2][m];
			u_td_2_next[L_max][m] = 2 * u_td_2_next[L_max - 1][m] - u_td_2_next[L_max - 2][m];
			u_td_3_next[L_max][m] = 2 * u_td_3_next[L_max - 1][m] - u_td_3_next[L_max - 2][m];
			u_td_4_next[L_max][m] = 2 * u_td_4_next[L_max - 1][m] - u_td_4_next[L_max - 2][m];
			u_td_5_next[L_max][m] = 2 * u_td_5_next[L_max - 1][m] - u_td_5_next[L_max - 2][m];
			u_td_6_next[L_max][m] = 2 * u_td_6_next[L_max - 1][m] - u_td_6_next[L_max - 2][m];
			u_td_7_next[L_max][m] = 2 * u_td_7_next[L_max - 1][m] - u_td_7_next[L_max - 2][m];
			u_td_8_next[L_max][m] = 2 * u_td_8_next[L_max - 1][m] - u_td_8_next[L_max - 2][m];
		}
